package com.litmethod.android.ui.Dashboard.AllClassTabScreen.EditProfile
...
import com.litmethod.android.ui.Dashboard.AllClassTabScreen.EditProfile.ViewModel.EditProfileViewModelFactory
...
//        binding.spLoading.visibility = View.VISIBLE
    ...
    private fun variableDataSetForUpdate() {
        ...
        Log.d("checktime","the time in millis ${System.currentTimeMillis()}")
        Log.d("thecity","the cities are ${AllClassesDataObject.profilePageData.countryCode}")
        countryCode = AllClassesDataObject.profilePageData.countryCode
        dialCode = AllClassesDataObject.profilePageData.dialCode
        last_name = AllClassesDataObject.profilePageData.lastName
        billing_city = AllClassesDataObject.profilePageData.billing_city
        billing_state = AllClassesDataObject.profilePageData.billing_state
        country = AllClassesDataObject.profilePageData.billing_country
        dob = AllClassesDataObject.profilePageData.dob
        first_name = AllClassesDataObject.profilePageData.firstName
        gender = AllClassesDataObject.profilePageData.gender
        heightUnit = AllClassesDataObject.profilePageData.heightUnit
        heightValueFeet = AllClassesDataObject.profilePageData.heightValueFeet.toString()
        heightValueInches = AllClassesDataObject.profilePageData.heightValueInches
//        phone = AllClassesDataObject.profilePageData.phone
        unit = AllClassesDataObject.profilePageData.weightUnit
        weight = AllClassesDataObject.profilePageData.weight.toString()
    }
    ...
    private fun clicKlistner() {
        ...
        Log.d("theProfileData","the profile data is ${AllClassesDataObject.profilePageData}")
        binding.firstName.text = AllClassesDataObject.profilePageData.firstName
        binding.lastName.text = AllClassesDataObject.profilePageData.lastName
        binding.userName.text = AllClassesDataObject.profilePageData.username
        binding.etDob.text = AllClassesDataObject.profilePageData.dob
        binding.etWeight.text = AllClassesDataObject.profilePageData.weight.toString()
        binding.etHightFt.text = AllClassesDataObject.profilePageData.heightValueFeet.toString()
        binding.etHightIn.text = AllClassesDataObject.profilePageData.heightValueInches.toString()
        binding.signupEtEmail.text = AllClassesDataObject.profilePageData.email
    ...
    private fun setupUi() {
        ...
        when(AllClassesDataObject.profilePageData.heightUnit){
...
//                        Log.d("thekg","the weight unit $weightUnit")
        ...
        when(AllClassesDataObject.profilePageData.weightUnit){
    ...
    override fun onClick(p0: View?) {
        when (p0!!.id) {
            ...
            R.id.iv_chooseimg ->{
                Log.d("buttonClick"," image button was clicked")
                getImage()
            }
        }
    }
