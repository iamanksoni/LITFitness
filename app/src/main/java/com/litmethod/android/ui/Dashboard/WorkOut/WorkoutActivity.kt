package com.litmethod.android.ui.Dashboard.WorkOut
...
import com.litmethod.android.ui.Dashboard.WorkOut.Adapter.WorkOutHistoryListParentAdapter
import com.litmethod.android.ui.Dashboard.WorkOut.Adapter.WorkoutDropDownAdapter
import com.litmethod.android.ui.Dashboard.WorkOut.ViewModel.WorkOutActivityViewModel
import com.litmethod.android.ui.Dashboard.WorkOut.ViewModel.WorkOutActivityViewModelFactory
...
class WorkoutActivity : AppCompatActivity(), WorkoutDropDownAdapter.WorkoutDropDownAdapterListener {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        getClassStatisticsList.addAll(AllClassesDataObject.getClassStatisticsList)
        workoutsTabAdapter()
        monthSpinner()
        yearSpinner()
        viewModelSetup()
        viewModel.checkgetClassHistoryList(AllClassesDataObject.accessToken, ClassHistoryListRequest(10,"classHistorylistV2","cl8esljwz8048i5p0yfyjw5q2",1,"10","2022"))
    }
    ...
    override fun onItemClick(position: Int, code: String) {
       ...
       if (position==0){
           if (isRvExtended){
               ...
               getClassStatisticsList.addAll(AllClassesDataObject.getClassStatisticsList)
               Log.d("valuechecking","value is ${AllClassesDataObject.getClassStatisticsList}")
...
//               workoutsTabAdapter()
               ...
               getClassStatisticsList.addAll(AllClassesDataObject.getClassStatisticsListAll)
//               workoutHistoryAdapter?.notifyDataSetChanged()
               Log.d("valuechecking","value is ${AllClassesDataObject.getClassStatisticsList}")
         ...
         val newFilteredArray =  AllClassesDataObject.getClassStatisticsListAll.filter {
               it.id==code
           }
           AllClassesDataObject.getClassStatisticsList.clear()
           AllClassesDataObject.getClassStatisticsList.addAll(newFilteredArray)
           getClassStatisticsList.clear()
