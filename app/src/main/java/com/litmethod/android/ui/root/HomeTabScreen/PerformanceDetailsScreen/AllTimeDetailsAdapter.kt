...
class AllTimeDetailsAdapter(
    val result: MutableList<HomePageVideosModel>,
    val context: Context,
    var rvAllTime: RecyclerView,
    var colournew: Int,
) : RecyclerView.Adapter<AllTimeDetailsViewHolder>() {
    var adapter: RecyclerView.Adapter<*>? = null
    lateinit var allTimeAdapterListener: AllTimeAdapterListener
    override fun onCreateViewHolder(p0: ViewGroup, p1: Int): AllTimeDetailsViewHolder {
        adapter = this
        return AllTimeDetailsViewHolder(
    ...
    override fun onBindViewHolder(holder: AllTimeDetailsViewHolder, position: Int) {
    ...
    private fun allTimeSelected(position: Int, holder: AllTimeDetailsViewHolder) {
...
class AllTimeDetailsViewHolder(view: View) : RecyclerView.ViewHolder(view) {
