...
import com.litmethod.android.ui.Dashboard.AllClassTabScreen.CoverScreen.ProgramsCoverScreen.ViewModel.ProgramsCoverAcivityViewModel
import com.litmethod.android.ui.Dashboard.AllClassTabScreen.CoverScreen.ProgramsCoverScreen.ViewModel.ProgramsCoverActivityViewModelFactory
...
class ProgramsCoverActivity : BaseActivity(), View.OnClickListener,
    ...
    private fun setUpUi() {
        binding.tvCatagory.text = AllClassesDataObject.getProgramByIdResponse.category
        Glide.with(this)
            .load(AllClassesDataObject.getProgramByIdResponse.image)
//            .placeholder(R.drawable.piwo_48)
//            .transform(new CircleTransform(context))
            .into(binding.expandedImage)
        binding.tvVideoDesc.text = AllClassesDataObject.getProgramsByIdToNextScreen.description
        binding.tvVideoTime.text = AllClassesDataObject.getProgramsByIdToNextScreen.week
        binding.tvIntermediate.text = AllClassesDataObject.getProgramByIdResponse.level

        when (AllClassesDataObject.getProgramByIdResponse.level){
            "Intermediate" -> {
        ...
        val secondWord = "with ${AllClassesDataObject.getProgramByIdResponse.instructorName}"
    ...
    private fun setUpAdapter(){
        dataList.clear()
        dataList2 = AllClassesDataObject.getProgramByIdResponse.weekVideos as ArrayList<WeekVideo>
...
//        dataList.add(ProgramsCoverData("Equipment & Accessories",dataListChildaa))
    ...
    override fun onItemClick(position: Int,code:String) {
        ...
        viewModel.checkgetClassDetails(AllClassesDataObject.accessToken, ClassDetailsRequest(AppConstants.actionTypegetClassDetails,code))
...
//        intentActivity(this, ClassesCoverActivity::class.java,"ProgramsCoverActivity")
    ...
    private fun loginResponse() {
        viewModel.classDetailsResponse.observe(this, Observer {
            ...
            AllClassesDataObject.getClassDetailsResponse=it.result.data
