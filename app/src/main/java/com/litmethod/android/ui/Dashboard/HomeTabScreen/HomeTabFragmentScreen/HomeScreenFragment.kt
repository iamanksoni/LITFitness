...
import com.litmethod.android.ui.Dashboard.HomeTabScreen.HomeViewModel
import com.litmethod.android.ui.Dashboard.HomeTabScreen.HomeViewModelFactory
...
//            it.programsmadeforyou.headerTitle
    ...
    private fun getTheAccessToken() {
        ...
        binding.tvHeader1.text =
            "Welcome ${AllClassesDataObject.profilePageData.firstName} ${AllClassesDataObject.profilePageData.lastName}"
    }
    ...
    override fun onItemClick(position: Int, data: String) {
        ...
        AllClassesDataObject.getProgramsByIdToNextScreen =
