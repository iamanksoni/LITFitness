package com.litmethod.android.ui.Dashboard.AccountTabScreen.AccountFragmentScreen.ViewModel
...
class AccountScreenViewModel  constructor(private val repository: AcountScreenFragmentRepository, var context: Context) :
    ...
    private fun getCalanderTrack(auth: String,getCalanderRequest: GetCalanderRequest) {
    ...
    fun checkgetCalanderTrack(auth: String,getCalanderRequest: GetCalanderRequest) {
        when {
            !NetworkHelper.instance.isNetworkAvailable(context) ->
                DialogueBox.showMsg(
                    context,
